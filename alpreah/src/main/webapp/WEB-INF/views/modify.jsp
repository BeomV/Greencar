...
<body>
    ...
    <div class="bodysection">
        ...
        <div class="contanier">
            ...
            <br>
            <span>
                <select value="${goods.carbrand}" style="width: 600px; height: 50px;" onchange="categoryChange(this)" id="carbrand" ">
                    <option>${goods.carbrand}</option>
            ...
            <li>
                ...
                <br>
                <select style="width: 600px; height: 50px;" id="carname" value="${goods.carname}">
                    <option>${goods.carname}</option>
                    <option>test</option>
                </select>             
            </li>
            <li>
                ...
                <br>
                <select style="width: 600px; height: 50px;" id="cartrim" value="${goods.cartrim}">
                    <option>${goods.cartrim}</option>
                    <option>------------------현대------------------</option>
                    <option>스마트</option>
                    <option>모던</option>
                    <option>프리미엄</option>
            ...
            <li>
                ...
                <br>
                <select style="width: 600px; height: 50px;" id="fueltype" value="${goods.fueltype}">
                    <option>${goods.fueltype}</option>
                    <option>가솔린</option>
                    <option>디젤</option>
                    <option>하이브리드</option>
                    <option>전기</option>
            ...
            <li>
                ...
                <br>
                <input type="text" placeholder="0km" style="text-align: center;" id="distance" value="${goods.distance}">
            </li>
            <li>
                <a><strong>차량 번호 :</strong></a>
                <br>
                <input type="text" placeholder="차량번호" style="text-align: center;" id="car_no" value="${goods.car_no}">
            </li>
            <li>
                <a><strong>세차 여부  :</strong></a>
                <br>
                <label><input type="radio" name="carwash" value="no" style="margin-right: 5px;" id="carwash" value="${goods.carwash}"> 완료</label>
                <label><input type="radio" name="carwash" value="Done" style="margin-right: 5px;" id="carwash" value="${goods.carwash}" > 미완료 </label>
                <br>
            ...
            <li>
                ...
                <!-- 
                <input type="button" value="완료" style="width: 290px; height: 50px; left: 30;" id="update_Btn">
                <input type="button" value="취소" style="width: 290px; height: 50px; left: 30;" id="back_Btn">
                 --> 
            </li>
        </ul>
        </form>
